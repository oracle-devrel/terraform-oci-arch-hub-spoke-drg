# terraform-oci-arch-hub-spoke-drg
...
Create a local copy of this repository:
    ...
    git clone https://github.com/oracle-devrel/terraform-oci-arch-hub-spoke-drg.git
